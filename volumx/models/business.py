...
class BusinessUserRights(BaseModel):
    ...
    productRights = db.Column(db.Boolean, default=True, nullable=False, unique=False)
    inventoryRights = db.Column(db.Boolean, default=True, nullable=False, unique=False)
    salesRights = db.Column(db.Boolean, default=True, nullable=False, unique=False)
    salesPosRights = db.Column(db.Boolean, default=True, nullable=False, unique=False)
    suppliersRights = db.Column(db.Boolean, default=True, nullable=False, unique=False)
    analyticsViewRights = db.Column(db.Boolean, default=True, nullable=False, unique=False)
    ownerRights = db.Column(db.Boolean, default=True, nullable=False, unique=False)
